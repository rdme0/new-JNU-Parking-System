...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/exit.css">
...
<body>
    ...
    <div class="container">
        <form:form action="/myproject/parking/exit" method="post" modelAttribute="car">
            <div class="title">출차하실 차량 번호를 입력하세요</div>
            <input class="input-field" type="text" id="carNumber" name="carNumber" placeholder="00가0000 또는 000가0000" oninput="checkCarNumber()">
            <div id="message"></div>
            <button type="submit" id="submitButton" disabled>출차하기</button>
            <!-- 처음에는 버튼 비활성화 -->
        </form:form>
